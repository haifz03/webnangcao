...
class Active extends Component {
  constructor(props) {
    super(props);
    this.state = {
      txtID: '643f4ea23ef68011c2177816',
      txtToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2OTk1MjgxMDQsImV4cCI6MTY5OTU2NDEwNH0.UTPvv5n5N2qIGa1-FCiiD31goGvxkY5cdhg9fUg1PHk'
    };
  }
  render() {
    return (
